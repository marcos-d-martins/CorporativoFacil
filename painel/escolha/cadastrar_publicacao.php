...
<body>
        ...
        <?php
            ...
            if(isset($posts) && $posts['publicar']):
                ...
                if($publica->getResult()):
                    ...
                    errosDoUsuarioCustomizados("Erro ao cadastrar: <b>{$publica->getErro()[0]}</b>", CORPF_LARANJADO);
                endif;
            endif;
            ...
            <section class="cadastra_post">
                ...
                <form name="cadastra_publicacao" method="post" enctype="multipart/form-data">
                    ...
                    <label>
                        ...
                        <textarea id="publicar" class="textarea_content" name="conteudo"><?php if(isset($posts['conteudo'])):echo $posts['conteudo']; endif;?> </textarea>
                    </label>
                    <label class="t_campo_arq">
                            ...
                            <?php
                                ...
                                if(!$lercategorias->resultado()):
                                    ...
                                    foreach($lercategorias->resultado() AS $categorias):
                                        //var_dump($lercategorias);
                                        echo "<option style='font-family: Verdana' value=\"{$categorias['id_cat']}\" ";

                                        if($categorias['id_cat'] == $posts['id_categoria']):
                    ...
                    <button class="btn_enviar" value="publicar" name="publicar">Publicar</button>
    ...
    <footer>
        ...
        <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js?apiKey=pchrvkadrgagkje38zltcs961dvi4i0807hk44zwfvfvlw1r" referrerpolicy="origin"></script>
        <script>
            tinymce.init({
              selector: '#publicar',
              language: 'pt_BR'
