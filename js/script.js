    ...
    $(".ajax_enviar").submit(function(){
        ...
        $.ajax({
            ...
            success: function (respostaPHP) {
                ...
                if(respostaPHP.erro){                    
                    formulario.find('.mostra-msg').html("<div class='exibe-msg err-msg'>"+ respostaPHP.erro +"</div>");                    formulario.find('.err-msg').fadeIn();
                }else{
                    formulario.find('.mostra-msg').html("<div class='exibe-msg success-msg'>"+ respostaPHP.sucesso +"</div>");
